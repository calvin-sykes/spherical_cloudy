...
#			print "Adopting Bondi Mass for the total baryon mass within r_200"
    ...
    while (not np.array_equal(tstcrit,allionpnt)) or (iteration <= miniter) or (not close):
        ...
        electrondensity = densitynH * ( (1.0-Yprofs[:,elID["H I"][0]]) + prim_He*Yprofs[:,elID["He II"].id] + 2.0*prim_He*(1.0-Yprofs[:,elID["He I"].id]-Yprofs[:,elID["He II"].id]) )
        ...
        for j in range(nions):
            if ions[j] == "H I":
                ratev = 4.0*np.pi * calc_Jnur.scdryrate(jnurarr, nuzero, phelxs[:,elID["H I"][0]], phelxs[:,elID["D I"].id], phelxs[:,elID["He I"].id], phelxs[:,elID["He II"].id],
                    prof_density[:,elID["H I"][0]], prof_density[:,elID["D I"].id], prof_density[:,elID["He I"].id], prof_density[:,elID["He II"].id],
                    electrondensity/(densitynH*(1.0 + 2.0*prim_He)), elID["H I"][2], elID["D I"].ip, elID["He I"].ip, elID["He II"].ip, planck, elvolt, 0)
                prof_scdryrate[:,j] = ratev.copy()
#			elif ions[j] == "D I":
#				ratev = 4.0*np.pi * calc_Jnur.scdryrate(jnurarr, nuzero, phelxs[:,elID["H I"][0]], phelxs[:,elID["D I"].id], phelxs[:,elID["He I"].id], phelxs[:,elID["He II"].id],
#					prof_density[:,elID["H I"][0]], prof_density[:,elID["D I"].id], prof_density[:,elID["He I"].id], prof_density[:,elID["He II"].id],
#					electrondensity/(densitynH*(1.0 + 2.0*prim_He)), elID["H I"][2], elID["D I"].ip, elID["He I"].ip, elID["He II"].ip, planck, elvolt, 1)
#				prof_scdryrate[:,j] = ratev.copy()
            elif ions[j] == "He I":
                ratev = 4.0*np.pi * 10.0 * calc_Jnur.scdryrate(jnurarr, nuzero, phelxs[:,elID["H I"][0]], phelxs[:,elID["D I"].id], phelxs[:,elID["He I"].id], phelxs[:,elID["He II"].id],
                    prof_density[:,elID["H I"][0]], prof_density[:,elID["D I"].id], prof_density[:,elID["He I"].id], prof_density[:,elID["He II"].id],
                    electrondensity/(densitynH*(1.0 + 2.0*prim_He)), elID["H I"][2], elID["D I"].ip, elID["He I"].ip, elID["He II"].ip, planck, elvolt, 2)
                prof_scdryrate[:,j] = ratev.copy()
